...
public class SslContextTest {
    final static String serverKeyStorePath =
            Resources.getResource("certificate-authority/jks/broker.keystore.jks").getPath();
    final static String serverTrustStorePath =
    ...
    final static String serverCertPath =  Resources.getResource("certificate-authority/server-keys/broker.cert.pem").getPath();
    final static String serverKeyPath =  Resources.getResource("certificate-authority/server-keys/broker.key-pk8.pem").getPath();
    ...
    public void testServerKeyStoreSSLContext(Set<String> cipher) throws Exception {
        NettySSLContextAutoRefreshBuilder contextAutoRefreshBuilder = new NettySSLContextAutoRefreshBuilder(
                null,
                keyStoreType, serverKeyStorePath, keyStorePassword, false,
                keyStoreType, serverTrustStorePath, keyStorePassword,
                true, cipher,
                null, 600);
