...
public class ProducerCreationTest extends ProducerConsumerBase {
    ...
    public void testCreateProducerWhenTopicTypeMismatch(TopicDomain domain)
        ...
        // Topic type is non-partitioned, trying to create producer on partitioned topic.
        ...
        // Topic type is partitioned, Trying to create producer on non-partitioned topic.
