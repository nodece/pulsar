...
public class PulsarInitialNamespaceSetup {
    ...
    public static int doMain(String[] args) throws Exception {
        PulsarInitialNamespaceSetup pulsarInitialNamespaceSetup = new PulsarInitialNamespaceSetup();
        CommandLine commander = new CommandLine(pulsarInitialNamespaceSetup);
        Arguments arguments;
        try {
            commander.parseArgs(args);
            arguments = pulsarInitialNamespaceSetup.arguments;
            if (arguments.help) {
