...
public class PulsarTransactionCoordinatorMetadataSetup {
    ...
    public static void main(String[] args) throws Exception {
        PulsarTransactionCoordinatorMetadataSetup pulsarTransactionCoordinatorMetadataSetup =
                new PulsarTransactionCoordinatorMetadataSetup();
        CommandLine commander = new CommandLine(pulsarTransactionCoordinatorMetadataSetup);
        Arguments arguments;
        try {
            commander.parseArgs(args);
            arguments = pulsarTransactionCoordinatorMetadataSetup.arguments;
            if (arguments.help) {
