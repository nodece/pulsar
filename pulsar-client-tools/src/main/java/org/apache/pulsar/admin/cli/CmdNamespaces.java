...
public class CmdNamespaces extends CmdBase {
    ...
    @Command(description = "Get the namespaces for a tenant in a cluster")
    ...
    @Command(description = "Get the list of destinations for a namespace")
    ...
    @Command(name = "get-dispatch-rate",
            description = "Get configured message-dispatch-rate for all topics of the namespace "
                    + "(Disabled if value < 0)"
    )
    ...
    @Command(name = "remove-subscription-dispatch-rate",
            description = "Remove subscription configured message-dispatch-rate for all topics of the namespace")
    ...
    @Command(name = "get-subscription-dispatch-rate",
            description = "Get subscription configured message-dispatch-rate for all topics of "
    ...
    @Command(name = "get-replicator-dispatch-rate",
            description = "Get replicator configured message-dispatch-rate for all topics of the namespace "
                    + "(Disabled if value < 0)"
    )
    ...
    @Command(name = "remove-replicator-dispatch-rate",
            description = "Remove replicator configured message-dispatch-rate for all topics of the namespace")
