...
public class WebSocketServiceStarter {
    ...
    public static void main(String[] args) throws Exception {
        WebSocketServiceStarter webSocketServiceStarter = new WebSocketServiceStarter();
        CommandLine commander = new CommandLine(webSocketServiceStarter);
        try {
            commander.parseArgs(args);
            Arguments arguments = webSocketServiceStarter.arguments;
            if (arguments.help) {
